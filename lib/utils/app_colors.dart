...
class AppColors {
  ...
  static const Color buttonTextOnLight = Color(
    0xFF1A1A1A,
  ); // High contrast for buttons on white/light bg
  static const Color buttonTextOnLightStrong = Color(
    0xFF000000,
  ); // Pure black for max visibility on light bg
  ...
  static const Color selectedAudienceBg = Color(
    0xFFE8F8EE,
  ); // Light green for selected audience chips
  ...
  static const Color dashboardInnerBg = Color(
    0xFFF4F3F2,
  ); // Light beige/gray for dashboard inner panel
  ...
  static const Color errorBannerBg = Color(
    0xFFF5D0D0,
